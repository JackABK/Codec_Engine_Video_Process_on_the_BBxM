  ...
  switch (io) {
    ...
    case IO_METHOD_READ:
      if (-1 == read (fd, buffers[0].start, buffers[0].length)) {
		...
		/*since I want to DSP doing , so I command this.*/
...
const char short_options [] = "d:ho:q:mruW:H:";
