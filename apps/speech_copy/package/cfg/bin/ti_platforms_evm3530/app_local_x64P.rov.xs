...
__o = __obj[2]  
    ...
    __o['cfgScript'] = String(java.net.URLDecoder.decode('local.tcf', 'UTF-8'))
    __o['cfgcopts'] = String(java.net.URLDecoder.decode('-DBUFALIGN%3D128+-DCACHE_ENABLED', 'UTF-8'))
    __o['copts'] = String(java.net.URLDecoder.decode('-DBUFALIGN%3D128+-DCACHE_ENABLED', 'UTF-8'))
...
__o = __obj[8]  // ti.targets.C64P
    ...
    __o['rootDir'] = String(java.net.URLDecoder.decode('%2Fhome%2Fjack%2Fti-dvsdk_dm3730-evm_4_01_00_09%2Fcgt6x_6_1_14', 'UTF-8'))
...
__o = __obj[67]  // ti.targets.C64P/ccOpts
    ...
    __o['prefix'] = String(java.net.URLDecoder.decode('-qq+-pdsw225+-pden+-pds%3D195+', 'UTF-8'))
    __o['suffix'] = String(java.net.URLDecoder.decode('', 'UTF-8'))
