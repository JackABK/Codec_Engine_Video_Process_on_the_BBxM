...
.libraries,v5T .libraries: lib/audenc_copy.av5T

-include lib/audenc_copy.av5T.mak
lib/audenc_copy.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.ov5T package/lib/lib/audenc_copy/audenc_copy.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.ov5T package/lib/lib/audenc_copy/audenc_copy.ov5T 
lib/audenc_copy.av5T:LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/audenc_copy.av5T
.libraries,64P .libraries: lib/audenc_copy.a64P

-include lib/audenc_copy.a64P.mak
lib/audenc_copy.a64P: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.o64P package/lib/lib/audenc_copy/audenc_copy.o64P  into $@ ...
	$(ti.targets.C64P.rootDir)/bin/ar6x  rq $@   package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.o64P package/lib/lib/audenc_copy/audenc_copy.o64P 
lib/audenc_copy.a64P:C_DIR=
lib/audenc_copy.a64P: PATH:=$(ti.targets.C64P.rootDir)/bin/:$(PATH)

clean,64P clean::
	-$(RM) lib/audenc_copy.a64P
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
audenc_copy.o64P,copy : package/lib/lib/audenc_copy/audenc_copy.o64P
audenc_copy.s64P,copy : package/lib/lib/audenc_copy/audenc_copy.s64P
package_ti.sdo.ce.examples.codecs.audenc_copy.o64P,copy : package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.o64P
package_ti.sdo.ce.examples.codecs.audenc_copy.s64P,copy : package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.s64P
audenc_copy.ov5T,copy : package/lib/lib/audenc_copy/audenc_copy.ov5T
audenc_copy.sv5T,copy : package/lib/lib/audenc_copy/audenc_copy.sv5T
package_ti.sdo.ce.examples.codecs.audenc_copy.ov5T,copy : package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.ov5T
package_ti.sdo.ce.examples.codecs.audenc_copy.sv5T,copy : package/lib/lib/audenc_copy/package/package_ti.sdo.ce.examples.codecs.audenc_copy.sv5T
...
ti_sdo_ce_examples_codecs_audenc_copy.tar: lib/audenc_copy.a64P
...
ti_sdo_ce_examples_codecs_audenc_copy.tar: lib/audenc_copy.av5T
