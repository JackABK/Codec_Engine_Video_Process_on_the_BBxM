...
__o = __obj[2]  
    ...
    __o['cfgScript'] = String(java.net.URLDecoder.decode('all.tcf', 'UTF-8'))
...
__o = __obj[5]  
    __o['attrs'] = __obj[6.0]
    __o['name'] = String(java.net.URLDecoder.decode('ti_sdo_ce_examples_servers_all_codecs', 'UTF-8'))
