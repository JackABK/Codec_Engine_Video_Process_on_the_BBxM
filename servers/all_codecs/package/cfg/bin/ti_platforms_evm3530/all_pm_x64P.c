 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/jack/ti-dvsdk_dm3730-evm_4_01_00_09/codec-engine_2_26_01_09/examples/ti/sdo/ce/examples/servers/all_codecs/package/cfg/bin/ti_platforms_evm3530/all_pm_x64P");
...
/*
 * ======== ti.bios.power.OMAP3530DSP TEMPLATE ========
 */

extern Void FXN_F_nop();

/* Initialize the DSP runtime context buffer. */
Uns _PWRM_LENGTHFORCONTEXTDSP = 0x40000;
Bool _PWRM_OVERRIDESAVRESDSP = FALSE;
...
Uns PWRM_edma3ChannelNum = 45;

/* hibernate support config params */
Bool ti_bios_power_stopBiosClockOnHibernate = TRUE;
Bool ti_bios_power_stopLoadMonitorOnHibernate = TRUE;
